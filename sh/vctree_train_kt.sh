...
MODEL.ROI_RELATION_HEAD.KNOWLEDGETRANS.PRETRAINED_FEATURE_PATH /home/miskai/デスクトップ/related-work/scene-graph-benchmark/SGG-TD2/checkpoints/vctree-sgcls-exmp/relu-concat-less-lr0.001/vis_record/vis.npy
