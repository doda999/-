...
class VCTreeLSTMContext(nn.Module):
    ...
    def __init__(self, config, obj_classes, rel_classes, statistics, in_channels):
        ...
        layer_init(self.obj_reduce, mode="xavier")
        layer_init(self.emb_reduce, mode="xavier")
        layer_init(self.score_pre, mode="xavier")
        layer_init(self.score_sub, mode="xavier")
        layer_init(self.score_obj, mode="xavier")
