...
from maskrcnn_benchmark.utils.taxonomy import build_taxonomy
from maskrcnn_benchmark.utils.groups import set_groups
...
class ROIRelationHead(torch.nn.Module):
    ...
    def forward(self, features, proposals, targets=None, logger=None):
        ...
        """
        if self.training or self.feat_record:
