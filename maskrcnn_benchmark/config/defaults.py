...
_C.MODEL.ROI_RELATION_HEAD.KNOWLEDGETRANS = CN()
_C.MODEL.ROI_RELATION_HEAD.KNOWLEDGETRANS.CONTEXT_LAYER = "motifs"
_C.MODEL.ROI_RELATION_HEAD.KNOWLEDGETRANS.FEAT_MODE = ""
_C.MODEL.ROI_RELATION_HEAD.KNOWLEDGETRANS.KNOWLEDGE_TRANSFER = True
_C.MODEL.ROI_RELATION_HEAD.KNOWLEDGETRANS.CALIBRATION_ALPHA = 10.0
# _C.MODEL.ROI_RELATION_HEAD.KNOWLEDGETRANS.VIS_RECORD = False
_C.MODEL.ROI_RELATION_HEAD.KNOWLEDGETRANS.PRETRAINED_FEATURE_PATH = ""
# _C.MODEL.ROI_RELATION_HEAD.KNOWLEDGETRANS.KNOWLEDGE_SOURCE = ()
_C.MODEL.ROI_RELATION_HEAD.KNOWLEDGETRANS.FEATURE_LOSS = "none"

_C.MODEL.ROI_RELATION_HEAD.PSKT = CN()
_C.MODEL.ROI_RELATION_HEAD.PSKT.CONTEXT_LAYER = 'motifs'
_C.MODEL.ROI_RELATION_HEAD.PSKT.FEAT_MODE = ""
_C.MODEL.ROI_RELATION_HEAD.PSKT.TAXONOMY_PATH = ""
_C.MODEL.ROI_RELATION_HEAD.PSKT.CALIBRATION_ALPHA = 10.0
_C.MODEL.ROI_RELATION_HEAD.PSKT.KNOWLEDGE_TRANSFER = True
_C.MODEL.ROI_RELATION_HEAD.PSKT.PRETRAINED_FEATURE_PATH = ""
_C.MODEL.ROI_RELATION_HEAD.PSKT.FEATURE_LOSS = "none"

_C.MODEL.ROI_RELATION_HEAD.PSKTALL = CN()
_C.MODEL.ROI_RELATION_HEAD.PSKTALL.CONTEXT_LAYER = 'motifs'
_C.MODEL.ROI_RELATION_HEAD.PSKTALL.FEAT_MODE = ""
_C.MODEL.ROI_RELATION_HEAD.PSKTALL.TAXONOMY_PATH = ""
_C.MODEL.ROI_RELATION_HEAD.PSKTALL.CALIBRATION_ALPHA = 10.0
_C.MODEL.ROI_RELATION_HEAD.PSKTALL.KNOWLEDGE_TRANSFER = True
_C.MODEL.ROI_RELATION_HEAD.PSKTALL.PRETRAINED_FEATURE_PATH = ""
_C.MODEL.ROI_RELATION_HEAD.PSKTALL.FEATURE_LOSS = "none"

_C.MODEL.ROI_RELATION_HEAD.PSKTROOTALL = CN()
_C.MODEL.ROI_RELATION_HEAD.PSKTROOTALL.CONTEXT_LAYER = 'motifs'
_C.MODEL.ROI_RELATION_HEAD.PSKTROOTALL.FEAT_MODE = ""
_C.MODEL.ROI_RELATION_HEAD.PSKTROOTALL.TAXONOMY_PATH = ""
_C.MODEL.ROI_RELATION_HEAD.PSKTROOTALL.CALIBRATION_ALPHA = 10.0
_C.MODEL.ROI_RELATION_HEAD.PSKTROOTALL.PRETRAINED_FEATURE_PATH = ""
_C.MODEL.ROI_RELATION_HEAD.PSKTROOTALL.FEATURE_LOSS = "none"

_C.MODEL.ROI_RELATION_HEAD.CAUSALPSKT = CN()
# direct and indirect effect analysis
_C.MODEL.ROI_RELATION_HEAD.CAUSALPSKT.EFFECT_ANALYSIS = False
# causal context feature layer
_C.MODEL.ROI_RELATION_HEAD.CAUSALPSKT.CONTEXT_LAYER = 'motifs'
# separate spatial in union feature
_C.MODEL.ROI_RELATION_HEAD.CAUSALPSKT.SEPARATE_SPATIAL = False
_C.MODEL.ROI_RELATION_HEAD.CAUSALPSKT.SPATIAL_FOR_VISION = False
_C.MODEL.ROI_RELATION_HEAD.CAUSALPSKT.EFFECT_TYPE = 'none' # 'TDE', 'TIE', 'TE'
_C.MODEL.ROI_RELATION_HEAD.CAUSALPSKT.KNOWLEDGE_TRANSFER = True
_C.MODEL.ROI_RELATION_HEAD.CAUSALPSKT.CALIBRATION_ALPHA = 10.0
_C.MODEL.ROI_RELATION_HEAD.CAUSALPSKT.TAXONOMY_PATH = ""
_C.MODEL.ROI_RELATION_HEAD.CAUSALPSKT.PRETRAINED_CTX_FEATURE_PATH = ""
_C.MODEL.ROI_RELATION_HEAD.CAUSALPSKT.PRETRAINED_VIS_FEATURE_PATH = ""
_C.MODEL.ROI_RELATION_HEAD.CAUSALPSKT.FEATURE_LOSS = "none"
_C.MODEL.ROI_RELATION_HEAD.CAUSALPSKT.FEATURE_LOSS_WEIGHT = 1.0
_C.MODEL.ROI_RELATION_HEAD.CAUSALPSKT.FINETUNE_FOR_RELATION = False

_C.MODEL.ROI_RELATION_HEAD.GPSNET = CN()
_C.MODEL.ROI_RELATION_HEAD.GPSNET.WORD_EMBEDDING_FEATURES = True
