...
_C.MODEL.ROI_RELATION_HEAD.PCPL = CN()
_C.MODEL.ROI_RELATION_HEAD.PCPL.CONTEXT_LAYER = "motifs"
_C.MODEL.ROI_RELATION_HEAD.PCPL.FEAT_EXTRACTOR = "concat"

_C.MODEL.ROI_RELATION_HEAD.KNOWLEDGETRANS = CN()
_C.MODEL.ROI_RELATION_HEAD.KNOWLEDGETRANS.CONTEXT_LAYER = "motifs"
_C.MODEL.ROI_RELATION_HEAD.KNOWLEDGETRANS.FEAT_EXTRACTOR = ""
_C.MODEL.ROI_RELATION_HEAD.KNOWLEDGETRANS.KNOWLEDGE_TRANSFER = True
_C.MODEL.ROI_RELATION_HEAD.KNOWLEDGETRANS.USE_CORRELATION = False
...
_C.MODEL.ROI_RELATION_HEAD.HIERARCHICALKT = CN()
_C.MODEL.ROI_RELATION_HEAD.HIERARCHICALKT.CONTEXT_LAYER = 'motifs'
_C.MODEL.ROI_RELATION_HEAD.HIERARCHICALKT.FEAT_EXTRACTOR = ""
_C.MODEL.ROI_RELATION_HEAD.HIERARCHICALKT.TAXONOMY_PATH = ""
_C.MODEL.ROI_RELATION_HEAD.HIERARCHICALKT.CALIBRATION_ALPHA = 10.0
_C.MODEL.ROI_RELATION_HEAD.HIERARCHICALKT.KNOWLEDGE_TRANSFER = True
_C.MODEL.ROI_RELATION_HEAD.HIERARCHICALKT.PRETRAINED_FEATURE_PATH = ""
_C.MODEL.ROI_RELATION_HEAD.HIERARCHICALKT.FEATURE_LOSS = "none"

_C.MODEL.ROI_RELATION_HEAD.HIERARCHICAL = CN()
_C.MODEL.ROI_RELATION_HEAD.HIERARCHICAL.CONTEXT_LAYER = 'motifs'
_C.MODEL.ROI_RELATION_HEAD.HIERARCHICAL.TAXONOMY_PATH = ""
_C.MODEL.ROI_RELATION_HEAD.HIERARCHICAL.VIS_RECORD = False

_C.MODEL.ROI_RELATION_HEAD.MINIGROUP = CN()
_C.MODEL.ROI_RELATION_HEAD.MINIGROUP.CONTEXT_LAYER = "motifs"
_C.MODEL.ROI_RELATION_HEAD.MINIGROUP.GROUPS_PATH = ""
